...
def go(args):
    ...
    mlflow.sklearn.save_model(
        ...
        signature=signature,
        input_example=X_val.iloc[:5], # First 5 rows as example
    )
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    """Generated the inference pipeline to be used in the deploy phase
    """
    ...
    logger.info('Random forest pipeline with a preprocessor is being returned')
